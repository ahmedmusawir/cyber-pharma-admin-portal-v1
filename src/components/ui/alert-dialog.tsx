...
// AlertDialog built on the installed @radix-ui/react-dialog (kit ships no
// @radix-ui/react-alert-dialog; this avoids a new dependency). Confirm-style:
// role="alertdialog", no dismiss-on-outside/esc, no close X — an explicit
// Action/Cancel decision only.
